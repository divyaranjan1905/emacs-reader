...
SRCS := render/elisp-helpers.c render/mupdf-helpers.c render/misc-helpers.c render/render-threads.c render/reader-render.c render/render-core.c render/render-theme.c render/render-highlight.c
OBJS := $(SRCS:%.c=%.o)
